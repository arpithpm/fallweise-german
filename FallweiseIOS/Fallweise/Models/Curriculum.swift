...
enum CurriculumLoader {
    ...
    static func lessons(from data: VocabularyData) -> [VoiceLesson] {
        let vocabulary = vocabularyLessons(from: data)
        let distribution = [2, 2, 2, 3, 2, 2, 2, 3, 2, 2, 2, 3]
        var unitCursor = 0
        return coreLessons.enumerated().flatMap { index, lesson in
    ...
    static var coreLessons: [VoiceLesson] {
        [
            core("01-meet-greet", "WORDS", "Meet & greet", "Greet someone and introduce yourself.", [
            ...
            core("02-who-does-what", "GRAMMAR", "Who does what?", "Build a sentence with a doer and an object.", [
            ...
            core("03-talk-now", "SPEAKING", "Talk about now", "Use present-tense verbs in useful sentences.", [
            ...
            core("04-everyday-world", "WORDS", "Your everyday world", "Connect vocabulary from home, food, travel, health, and work.", [
            ...
            core("05-questions-order", "GRAMMAR", "Questions & word order", "Ask for information with the verb in the right place.", [
            ...
            core("06-can-want-must", "SPEAKING", "Can, want, must", "Express ability, wishes, and needs with modal verbs.", [
            ...
            core("07-hear-spell", "SOUNDS", "Hear it, spell it", "Recognize German umlauts, ß, and reliable sound patterns.", [
            ...
            core("08-numbers-time", "DAILY LIFE", "Numbers, time & dates", "Tell the time and make a simple appointment.", [
            ...
            core("09-real-conversations", "DIALOGUE", "Real conversations", "Handle introductions, shopping, and polite exchanges.", [
            ...
            core("10-no-mine-yours", "GRAMMAR", "No, mine & yours", "Use nicht, kein, and possessive words.", [
            ...
            core("11-everyday-life", "SKILLS", "Everyday life lab", "Describe work, hobbies, shopping, and routines.", [
            ...
            core("12-speak-replay", "SPEAKING", "Speak & replay", "Bring your A1 patterns together in one introduction.", [
    ...
    private static func vocabularyLessons(from data: VocabularyData) -> [VoiceLesson] {
    ...
    private static func core(_ id: String, _ type: String, _ title: String, _ goal: String, _ steps: [LessonStep]) -> VoiceLesson {
        VoiceLesson(id: id, title: title, type: type, goal: goal, unit: nil, batch: nil, wordStart: nil, steps: steps)
    }

    private static func step(_ id: String, _ kind: String, _ visual: String, _ hint: String, _ prompt: String, _ answers: [String] = [], _ success: String = "", _ retry: String = "") -> LessonStep {
